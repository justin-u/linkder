...
//     console.log(this.props);
//     if (this.props.otherUser) {
//       this.props.firebase.messages(this.state.authUser.uid, this.props.otherUser.id).on('value', snapshot => {
//         const messageList = snapshot.val();
//         console.log(messageList);
...
//               <
//             Link to={
//                   "/report/" + otherUser + "/from/" + this.state.authUser.uid
//                 }
//                 style={
//                   {
//                     color: '#ffffff',
...
//                             icon="ion-ios-camera" />, <
//                             ToolbarButton key="image"
//                             icon="ion-ios-image" />, <
//                             ToolbarButton key="audio"
//                             icon="ion-ios-mic" />, <
//                             ToolbarButton key="money"
//                             icon="ion-ios-card" />, <
//                             ToolbarButton key="games"
//                             icon="ion-logo-game-controller-b" />, <
//                             ToolbarButton key="emoji"
//                             icon="ion-ios-happy" />
//                           ]
//                         }
//                       /> <
